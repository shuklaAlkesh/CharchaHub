...
import {UPDATE_PROFILE_ROUTES} from '@/utils/constants.js';
import {ADD_PROFILE_IMAGE_ROUTES} from '@/utils/constants.js';
import {REMOVE_PROFILE_IMAGE_ROUTES} from '@/utils/constants.js';
    ...
    if(validateProfile()){
      try{
        const response = await apiClient.post(
          UPDATE_PROFILE_ROUTES,{firstName,lastName,color:selectedColor},
      ...
      <div className="flex flex-col gap-10 w-[80vh] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/50 ring-fuchsia-50 rounded-full z-10"
